...
# 
#
# Usage: ./Resolution.sh  net.solver InitialMarking DAC
#
#  1) solver 
#  2) Initial Marking file
#  3) if 1 -> DAC therapy, else -> no DAC
#------------------------------------------------------------------------
function float_gt() {
...
##  Let define the injection times
    ...
    numberEBV=1000
            ...
            ./$1 "$nameSol" -ftime $InjTime[0]  -stime 24 -type LSODA -init $2 > log.txt
